...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!is_valid_email($email)) {
        ...
        $error = "Password hanya boleh huruf dan angka tanpa simbol!";
    } else {
        ...
        if ($result->num_rows === 1) {
            ...
            if (password_verify($password, $user['password'])) {
                ...
                // Redirect dengan JavaScript dan set sessionStorage
                echo "<script>
                    // Clear sessionStorage dulu
                    sessionStorage.clear();
                    
                    // Set data login baru
                    sessionStorage.setItem('admin_authenticated', 'true');
                    sessionStorage.setItem('admin_login_time', '" . time() . "');
                    sessionStorage.setItem('admin_email', '" . htmlspecialchars($email) . "');
...
<script>
// Clear sessionStorage saat halaman login dimuat
